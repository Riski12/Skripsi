  ...
  ******************************************************************/
  for ( i = 0 ; i < HiddenNodes ; i++ ) {
    for ( j = 0 ; j <= InputNodes ; j++ ) {
      ...
      HiddenWeights[j][i] = 2.0 * ( Rando - 0.5 ) * InitialWeightMax ; // ( Rando - 0.5 )agar range menjadi -0.5 -- 0.5
  ...
  ******************************************************************/
  ...
  for ( TrainingCycle = 1 ; TrainingCycle < 2147483647 ; TrainingCycle++) {
    ...
    ******************************************************************/
    ...
    for ( p = 0 ; p < PatternCount ; p++) { //menukar posisi index array p dan q
    ...
    ******************************************************************/
    for ( q = 0 ; q < PatternCount ; q++ ) {
      ...
      ******************************************************************/
      for ( i = 0 ; i < HiddenNodes ; i++ ) {
        Accum = HiddenWeights[InputNodes][i] ; //coba ubah bias jadi 1
        for ( j = 0 ; j < InputNodes ; j++ ) {
          Accum += Input[p][j] * HiddenWeights[j][i] ; //backpropnya
